...
<section class="updates-new">
    ...
    <div class="updates-cart">
        <div class="cart">
            <img src="Image/upcomming002.jpg">
            <h5>Date: 1 May 2023 </h5>
            <h4> <a href="#">Top three products design excellent upcomming on the store for you!!</a></h4>
            ...
            <h6> Let's Waiting Until Debut...</h6>
        </div>
        <div class="cart">
            <img src="Image/upcomming003.jpg">
            <h5>Date: 1 May 2023 </h5>
            <h4> <a href="#">The collection in May for you</a></h4>
            <p> Mẫu đầm xòe dự tiệc 3789 chất liệu vải gấm Tapta cao cấp phối
                ren màu đen với thiết kế sang trọng và vô cùng thời thượng.
                <!-- Sản phẩm gấm màu đen mặc đi tiệc với họa tiết dập nổi, -->
                <!-- thiết kế cổ vest đơn giản tạo nên tổng thể bộ trang phục thanh lịch, gọn gàng. -->
        ...
        <div class="cart">
            <img src="Image/upcomming004.png">
            <h5>Date: 1 May 2023 </h5>
            <h4> <a href="#">Top three products design excellent upcomming on the store for you!!</a></h4>
            <p> Mẫu đầm xòe dự tiệc 3789 chất liệu vải gấm Tapta cao cấp phối
                ren màu đen với thiết kế sang trọng và vô cùng thời thượng.
        ...
        <div class="cart">
            <img src="Image/upcomming001.jpg">
            <h5>Date: 1 May 2023 </h5>
            <h4> <a href="#">Top three products design excellent upcomming on the store for you!!</a></h4>
            <p> Mẫu đầm xòe dự tiệc 3789 chất liệu vải gấm Tapta cao cấp phối
                ren màu đen với thiết kế sang trọng và vô cùng thời thượng.
